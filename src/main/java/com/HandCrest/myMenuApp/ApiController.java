...
public class ApiController {
	...
	public Collection<Item> addItem(@PathVariable(name = "menuId") Long menuId,
		...
		itemRepo.save(new Item(itemName, description, bigDecimalPrice, picture, calories, ingredients, true,menuRepo.findOne(menuId)));return menuRepo.findOne(menuId).getItems();
	}
